 ...
 * @param amount_unique_letters Quantity of different (unique) letters(characters).
...
/**
 * @brief Takes an array with numbers separed in digits, unite the digits(of a vector)
 * into a number and store it into another array.
 * @code{.c}
 * @endcode
 ...
 * @details Perform the respective sum of all word_values to verify that the result 
 * a valid solution of the cryptarithm.
 * @see convert_digits_to_value
 * @return true if the sum of the word_values is equal to the expected result, else false
 */
